...
async function updateUnit() {
    formRef.value.validate().then((validate) => {
        if (validate.valid) {
            ...
            SettingRepository.UpdateUnit(
                SettingRepository.unit.id,
            ...
            <v-card class="px-3">
                ...
                <v-card-text>
                    <v-form ref="formRef" class="d-flex gap-4">
                        <div class="w-full">
                            <v-text-field
                                v-model="SettingRepository.unit.name"
                                variant="outlined"
                                label="Name"
                            ...
                            ></v-text-field>
                            <v-text-field
                                v-model="SettingRepository.unit.shortName"
                                variant="outlined"
                                label="Rate"
                                class="pb-4"
                            ></v-text-field>
                ...
                <div class="justify-start pl-6 pb-6">
                    <v-btn color="light-blue-darken-1" @click="updateUnit"
                        >Update</v-btn
                    >
                </div>
            </v-card>
